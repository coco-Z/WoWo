...
namespace XLua.CSObjectWrap
{
    ...
    public class PlayerStateSkill1Wrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(PlayerStateSkill1);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new PlayerStateSkill1();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to PlayerStateSkill1 constructor!");
        ...
        static int _m_HandleInput(RealStatePtr L)
        {
		    try {
                ...
                PlayerStateSkill1 gen_to_be_invoked = (PlayerStateSkill1)translator.FastGetCSObj(L, 1);
