...
namespace XLua.CSObjectWrap
{
    ...
    public class PlayerStateAttackWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(PlayerStateAttack);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new PlayerStateAttack();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to PlayerStateAttack constructor!");
        ...
        static int _m_HandleInput(RealStatePtr L)
        {
		    try {
                ...
                PlayerStateAttack gen_to_be_invoked = (PlayerStateAttack)translator.FastGetCSObj(L, 1);
