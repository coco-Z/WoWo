...
namespace XLua.CSObjectWrap
{
    ...
    public class PlayerStateJumpWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(PlayerStateJump);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new PlayerStateJump();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to PlayerStateJump constructor!");
        ...
        static int _m_HandleInput(RealStatePtr L)
        {
		    try {
                ...
                PlayerStateJump gen_to_be_invoked = (PlayerStateJump)translator.FastGetCSObj(L, 1);
