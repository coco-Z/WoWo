...
namespace XLua.CSObjectWrap
{
    ...
    public class PlayerStateSkill3Wrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(PlayerStateSkill3);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new PlayerStateSkill3();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to PlayerStateSkill3 constructor!");
        ...
        static int _m_HandleInput(RealStatePtr L)
        {
		    try {
                ...
                PlayerStateSkill3 gen_to_be_invoked = (PlayerStateSkill3)translator.FastGetCSObj(L, 1);
