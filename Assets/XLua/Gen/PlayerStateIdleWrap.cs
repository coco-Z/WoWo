...
namespace XLua.CSObjectWrap
{
    ...
    public class PlayerStateIdleWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(PlayerStateIdle);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new PlayerStateIdle();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to PlayerStateIdle constructor!");
        ...
        static int _m_HandleInput(RealStatePtr L)
        {
		    try {
                ...
                PlayerStateIdle gen_to_be_invoked = (PlayerStateIdle)translator.FastGetCSObj(L, 1);
