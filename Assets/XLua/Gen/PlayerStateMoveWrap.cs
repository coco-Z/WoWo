...
namespace XLua.CSObjectWrap
{
    ...
    public class PlayerStateMoveWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(PlayerStateMove);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new PlayerStateMove();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to PlayerStateMove constructor!");
        ...
        static int _m_HandleInput(RealStatePtr L)
        {
		    try {
                ...
                PlayerStateMove gen_to_be_invoked = (PlayerStateMove)translator.FastGetCSObj(L, 1);
