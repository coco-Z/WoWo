...
namespace XLua.CSObjectWrap
{
    ...
    public class PlayerStateSkill2Wrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(PlayerStateSkill2);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new PlayerStateSkill2();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to PlayerStateSkill2 constructor!");
        ...
        static int _m_HandleInput(RealStatePtr L)
        {
		    try {
                ...
                PlayerStateSkill2 gen_to_be_invoked = (PlayerStateSkill2)translator.FastGetCSObj(L, 1);
