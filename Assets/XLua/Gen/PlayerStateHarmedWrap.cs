...
namespace XLua.CSObjectWrap
{
    ...
    public class PlayerStateHarmedWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(PlayerStateHarmed);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new PlayerStateHarmed();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to PlayerStateHarmed constructor!");
        ...
        static int _m_HandleInput(RealStatePtr L)
        {
		    try {
                ...
                PlayerStateHarmed gen_to_be_invoked = (PlayerStateHarmed)translator.FastGetCSObj(L, 1);
